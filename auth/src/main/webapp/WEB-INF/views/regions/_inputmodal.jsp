...
<!-- Modal -->
<div class="modal fade" id="appendRegionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="input-group" style="width: 100%;">
                    <span class="label label-default">Наименование региона</span>
                    <input type="text"
                           class="form-control"
                           placeholder="Наименование региона"
                           maxlength="32"
                           data-role="region-name-input"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-role="region-append">Подтвердить</button>
            </div>
        </div>
    </div>
</div>
